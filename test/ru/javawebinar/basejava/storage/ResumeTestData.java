...
public class ResumeTestData {
    public Resume createTestResume(String uuid, String fullName) {
        Resume resume = new Resume(uuid, fullName);
        resume.addContact(ContactType.PHONE, "123456");
        resume.addContact(ContactType.EMAIL, "mail@mail.ru");
        ...
        resume.addSection(SectionType.ACHIEVEMENT, new ListSection(new ArrayList<>(Arrays.asList("Achivement1", "Achivement2"))));
        resume.addSection(SectionType.QUALIFICATIONS, new ListSection(new ArrayList<>(Arrays.asList("Qualification1", "Qualification2"))));

        Company company1 = new Company("Google", "google.com", DateUtil.of(2010, Month.JULY), DateUtil.of(2015, Month.MARCH), "Tester", "Description1");
        Company company2 = new Company("Amazon", "amazon.com", DateUtil.of(2015, Month.APRIL), DateUtil.of(2020, Month.DECEMBER), "Developer", "Description2");
        resume.addSection(SectionType.EXPERIENCE, new CompanySection(new ArrayList<>(Arrays.asList(company1, company2))));

        Company university = new Company("University", "123.com", DateUtil.of(2005, Month.SEPTEMBER), DateUtil.of(2010, Month.JUNE), "Student", null);
        Company courses = new Company("Course", "321.com", DateUtil.of(2010, Month.JULY), DateUtil.of(2010, Month.DECEMBER), "Java", null);
